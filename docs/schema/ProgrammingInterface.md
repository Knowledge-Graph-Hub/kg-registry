...
```mermaid
 classDiagram
    ...
    click Contact href "Contact.html"
      ...
      ProgrammingInterface : derived_from
        
          
    
    
    ProgrammingInterface --> "0..1" Resource : derived_from
    ...
    ProgrammingInterface --> "0..1" Resource : original_source
    click Resource href "Resource.html"
