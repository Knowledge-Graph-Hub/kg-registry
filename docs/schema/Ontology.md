...
_An ontology is a formal representation of a set of concepts within a domain and the relationships between those concepts. It is used to reason about the properties of that domain and may be used in construction of a knowledge graph._





URI: [kgr:Ontology](https://w3id.org/bridge2ai/data-sheets-schema/Ontology)
...
```mermaid
 classDiagram
    ...
    click Ontology href "Ontology/.html"
      ...
      Ontology : activity_status





        Ontology --> "0..1" ActivityStatusEnum : activity_status
      ...
      Ontology : collection
        ...
        Ontology --> "*" CollectionEnum : collection
      ...
      Ontology : domains
        ...
        Ontology --> "1..*" DomainEnum : domains
        click DomainEnum href "DomainEnum/.html"



      Ontology : fairsharing_id
      ...
      Ontology : funding
        ...
        Ontology --> "*" FundingSource : funding
        click FundingSource href "FundingSource/.html"



      Ontology : homepage_url
      ...
      Ontology : publications
        ...
        Ontology --> "*" Publication : publications
...
```yaml
name: Ontology
description: An ontology is a formal representation of a set of concepts within a
  domain and the relationships between those concepts. It is used to reason about
  the properties of that domain and may be used in construction of a knowledge graph.
