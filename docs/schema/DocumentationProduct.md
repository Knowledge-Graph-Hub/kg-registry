...
# Class: DocumentationProduct


_A product that is documentation for a resource. This may be a website, a stand-alone document, or a collection of documents._





URI: [kgr:DocumentationProduct](https://w3id.org/bridge2ai/data-sheets-schema/DocumentationProduct)
...
```mermaid
 classDiagram
    ...
    click DocumentationProduct href "DocumentationProduct/.html"
      ...
      DocumentationProduct : category

      DocumentationProduct : collection





        DocumentationProduct --> "*" CollectionEnum : collection
        click CollectionEnum href "CollectionEnum/.html"



      DocumentationProduct : compatibility





        DocumentationProduct --> "*" StandardCompatibility : compatibility
        click StandardCompatibility href "StandardCompatibility/.html"



      DocumentationProduct : compression





        DocumentationProduct --> "0..1" CompressionEnum : compression
        click CompressionEnum href "CompressionEnum/.html"



      DocumentationProduct : contacts





        DocumentationProduct --> "*" Contact : contacts
        click Contact href "Contact/.html"



      DocumentationProduct : creation_date

      DocumentationProduct : curators





        DocumentationProduct --> "*" Contact : curators
        click Contact href "Contact/.html"
      ...
      DocumentationProduct : dump_format





        DocumentationProduct --> "0..1" DumpFormatEnum : dump_format
        click DumpFormatEnum href "DumpFormatEnum/.html"



      DocumentationProduct : format





        DocumentationProduct --> "0..1" FormatEnum : format
        click FormatEnum href "FormatEnum/.html"



      DocumentationProduct : id

      DocumentationProduct : infores_id

      DocumentationProduct : last_modified_date

      DocumentationProduct : latest_version

      DocumentationProduct : layout

      DocumentationProduct : license





        DocumentationProduct --> "0..1" License : license
      ...
      DocumentationProduct : original_source





        DocumentationProduct --> "*" SourceAssociation : original_source
        click SourceAssociation href "SourceAssociation/.html"



      DocumentationProduct : produced_by





        DocumentationProduct --> "*" ProcessProduct : produced_by
        click ProcessProduct href "ProcessProduct/.html"



      DocumentationProduct : product_file_size

      DocumentationProduct : product_url

      DocumentationProduct : repository

      DocumentationProduct : secondary_source





        DocumentationProduct --> "*" SourceAssociation : secondary_source
        click SourceAssociation href "SourceAssociation/.html"



      DocumentationProduct : tags





        DocumentationProduct --> "*" TagEnum : tags
        click TagEnum href "TagEnum/.html"



      DocumentationProduct : versions

      DocumentationProduct : warnings
...
| ---  | ---  |
| self | kgr:DocumentationProduct |
| native | kgr:DocumentationProduct |
...
<details>
```yaml
name: DocumentationProduct
description: A product that is documentation for a resource. This may be a website,
  a stand-alone document, or a collection of documents.
