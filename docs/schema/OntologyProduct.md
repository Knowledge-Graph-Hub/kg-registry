...
_A product that is an ontology, a formal representation of a set of concepts within a domain and the relationships between those concepts._





URI: [kgr:OntologyProduct](https://w3id.org/bridge2ai/data-sheets-schema/OntologyProduct)
