...
```mermaid
 classDiagram
    ...
    click GraphicalInterface href "GraphicalInterface/.html"
      ...
      GraphicalInterface : collection





        GraphicalInterface --> "*" CollectionEnum : collection
      ...
      GraphicalInterface : creation_date

      GraphicalInterface : curators





        GraphicalInterface --> "*" Contact : curators
        click Contact href "Contact/.html"
      ...
      GraphicalInterface : last_modified_date

      GraphicalInterface : latest_version
      ...
      GraphicalInterface : original_source
        ...
        GraphicalInterface --> "*" SourceAssociation : original_source
      ...
      GraphicalInterface : product_file_size
      ...
      GraphicalInterface : secondary_source
        ...
        GraphicalInterface --> "*" SourceAssociation : secondary_source
        click SourceAssociation href "SourceAssociation/.html"
