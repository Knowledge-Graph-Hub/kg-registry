...
_The date the entry was created. This is used to determine the age of the entity. It should be in ISO 8601 format, e.g., 2024-02-12T00:00:00Z._





URI: [kgr:creation_date](https://w3id.org/bridge2ai/data-sheets-schema/creation_date)
Alias: creation_date
