...
```mermaid
 classDiagram
    ...
    click GraphProduct href "GraphProduct/.html"
      ...
      GraphProduct : collection





        GraphProduct --> "*" CollectionEnum : collection
      ...
      GraphProduct : creation_date

      GraphProduct : curators





        GraphProduct --> "*" Contact : curators
        click Contact href "Contact/.html"
      ...
      GraphProduct : last_modified_date

      GraphProduct : latest_version
      ...
      GraphProduct : original_source
        ...
        GraphProduct --> "*" SourceAssociation : original_source
      ...
      GraphProduct : product_file_size
      ...
      GraphProduct : secondary_source
        ...
        GraphProduct --> "*" SourceAssociation : secondary_source
        click SourceAssociation href "SourceAssociation/.html"
