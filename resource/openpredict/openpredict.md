...
- category: Product
  ...
  - File was not able to be retrieved when checked on 2025-11-25_ HTTP 405 error when
    accessing file
  - File was not able to be retrieved when checked on 2025-11-26_ HTTP 405 error when
    accessing file
  - 'File was not able to be retrieved when checked on 2025-12-04: HTTP 405 error
    when accessing file'
publications:
