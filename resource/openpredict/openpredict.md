...
- category: Product
  ...
  - File was not able to be retrieved when checked on 2025-11-21_ HTTP 405 error when
    accessing file
  - File was not able to be retrieved when checked on 2025-11-22_ HTTP 405 error when
    accessing file
  - 'File was not able to be retrieved when checked on 2025-11-25: HTTP 405 error
    when accessing file'
publications:
