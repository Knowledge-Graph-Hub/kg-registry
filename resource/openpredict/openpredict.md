...
- category: Product
  ...
  - File was not able to be retrieved when checked on 2025-12-05_ HTTP 405 error when
    accessing file
  - File was not able to be retrieved when checked on 2025-12-07_ HTTP 405 error when
    accessing file
  - 'File was not able to be retrieved when checked on 2025-12-08: HTTP 405 error
    when accessing file'
publications:
