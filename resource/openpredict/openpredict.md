...
- category: Product
  ...
  - File was not able to be retrieved when checked on 2025-11-10_ HTTP 405 error when
    accessing file
  - File was not able to be retrieved when checked on 2025-11-11_ HTTP 405 error when
    accessing file
  - 'File was not able to be retrieved when checked on 2025-11-13: HTTP 405 error
    when accessing file'
publications:
