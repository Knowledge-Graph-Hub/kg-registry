...
contacts:
  ...
  - category: Organization
    ...
    label: Skaggs School of Pharmacy and Pharmaceutical Sciences, University of California San Diego
...
products:
  - category: Product
    compression: zip
    description: Full dataset containing all binding measurements in BindingDB with 2D compound structures
    format: sdf
    id: bindingdb.all_2d
