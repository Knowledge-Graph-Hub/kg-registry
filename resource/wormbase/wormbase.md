...
- category: Product
  ...
  - File was not able to be retrieved when checked on 2026-02-21_ FTP error_ [Errno
    101] Network is unreachable
  - 'File was not able to be retrieved when checked on 2026-02-22: FTP error: [Errno
    101] Network is unreachable'
- category: GraphicalInterface
