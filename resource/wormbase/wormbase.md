...
- category: Product
  ...
  warnings:
  - File was not able to be retrieved when checked on 2026-02-24_ FTP error_ [Errno
  ...
  - File was not able to be retrieved when checked on 2026-02-25_ FTP error_ [Errno
    101] Network is unreachable
  - 'File was not able to be retrieved when checked on 2026-02-25: FTP error: [Errno
    101] Network is unreachable'
- category: GraphicalInterface
