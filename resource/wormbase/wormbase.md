...
- category: Product
  ...
  warnings:
  - File was not able to be retrieved when checked on 2025-12-17_ FTP error_ [Errno
  ...
  - File was not able to be retrieved when checked on 2025-12-18_ FTP error_ [Errno
    101] Network is unreachable
  - 'File was not able to be retrieved when checked on 2025-12-18: FTP error: [Errno
    101] Network is unreachable'
- category: GraphicalInterface
