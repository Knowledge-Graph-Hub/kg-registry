...
- category: Product
  ...
  - File was not able to be retrieved when checked on 2026-02-13_ FTP error_ [Errno
    101] Network is unreachable
  - 'File was not able to be retrieved when checked on 2026-02-15: FTP error: [Errno
    101] Network is unreachable'
- category: GraphicalInterface
