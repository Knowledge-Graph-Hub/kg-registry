...
- category: Product
  ...
  warnings:
  - File was not able to be retrieved when checked on 2026-02-26_ FTP error_ [Errno
  ...
  - File was not able to be retrieved when checked on 2026-03-08_ FTP error_ [Errno
    101] Network is unreachable
  - 'File was not able to be retrieved when checked on 2026-03-11: FTP error: [Errno
    101] Network is unreachable'
- category: GraphicalInterface
