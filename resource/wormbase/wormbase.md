...
- category: Product
  ...
  warnings:
  - File was not able to be retrieved when checked on 2026-01-23_ FTP error_ [Errno
  ...
  - File was not able to be retrieved when checked on 2026-01-28_ FTP error_ [Errno
    101] Network is unreachable
  - 'File was not able to be retrieved when checked on 2026-01-30: FTP error: [Errno
    101] Network is unreachable'
- category: GraphicalInterface
