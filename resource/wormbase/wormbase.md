...
- category: Product
  ...
  - File was not able to be retrieved when checked on 2026-03-11_ FTP error_ [Errno
    101] Network is unreachable
  - 'File was not able to be retrieved when checked on 2026-03-30: FTP error: [Errno
    101] Network is unreachable'
- category: GraphicalInterface
