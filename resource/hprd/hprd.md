...
- category: Product
  ...
  warnings:
  - File was not able to be retrieved when checked on 2026-01-06_ HTTP 503 error when
    accessing file
  - Original HPRD website is no longer accessible. Data has been archived in iRefIndex
    and other interaction databases.
  - File was not able to be retrieved when checked on 2026-01-07_ HTTP 503 error when
    accessing file
  - 'File was not able to be retrieved when checked on 2026-01-15: HTTP 503 error
    when accessing file'
