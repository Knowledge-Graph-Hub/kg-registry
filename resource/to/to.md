...
Plant Trait Ontology in OWL format

**URL**: [http://purl.obolibrary.org/obo/to.owl](http://purl.obolibrary.org/obo/to.owl)

**Format**: owl

### to.obo

Plant Trait Ontology in OBO format

**URL**: [http://purl.obolibrary.org/obo/to.obo](http://purl.obolibrary.org/obo/to.obo)
