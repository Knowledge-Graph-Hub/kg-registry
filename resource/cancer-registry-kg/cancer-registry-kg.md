...
- category: GraphProduct
  ...
  - File was not able to be retrieved when checked on 2026-02-15_ HTTP 403 error when
    accessing file
  - File was not able to be retrieved when checked on 2026-02-21_ HTTP 405 error when
    accessing file
  - 'File was not able to be retrieved when checked on 2026-02-22: HTTP 405 error
    when accessing file'
- category: GraphProduct
