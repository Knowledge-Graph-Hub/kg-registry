...
description: ADReCS is a database of adverse drug reaction terms and drug-side effect
  relationships used for pharmacovigilance and drug safety analysis.
domains:
- biomedical
- pharmacology
...
products:
- category: Product
  description: ADReCS web resource for browsing adverse drug reaction concepts and
    associations.
  format: http
  id: adrecs.web
  name: ADReCS Web Resource
  original_source:
  - relation_type: prov:hadPrimarySource
    source: adrecs
  product_url: http://www.bio-add.org/ADReCS/
...
ADReCS is a data source for adverse drug reactions and related pharmacovigilance knowledge.