...
- category: Product
  ...
  warnings:
  - 'File was not able to be retrieved when checked on 2025-08-26: HTTP 401 error
    when accessing file'
  - 'File was not able to be retrieved when checked on 2025-08-28: HTTP 401 error
    when accessing file'
- category: Product
