...
- category: Product
  ...
  - File was not able to be retrieved when checked on 2025-12-08_ HTTP 401 error when
    accessing file
  - File was not able to be retrieved when checked on 2025-12-09_ HTTP 401 error when
    accessing file
  - 'File was not able to be retrieved when checked on 2025-12-11: HTTP 401 error
    when accessing file'
- category: Product
