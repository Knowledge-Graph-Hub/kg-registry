...
- category: Product
  ...
  - File was not able to be retrieved when checked on 2026-03-30_ HTTP 401 error when
    accessing file
  - 'File was not able to be retrieved when checked on 2026-05-09: HTTP 401 error
    when accessing file'
  - 'File was not able to be retrieved when checked on 2026-05-19: HTTP 401 error
    when accessing file'
- category: Product
