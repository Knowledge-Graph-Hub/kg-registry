...
- category: Product
  ...
  warnings:
  - 'File was not able to be retrieved when checked on 2025-09-02: HTTP 401 error
    when accessing file'
  - 'File was not able to be retrieved when checked on 2025-09-03: HTTP 401 error
    when accessing file'
- category: Product
