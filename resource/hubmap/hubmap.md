...
- category: Product
  ...
  warnings:
  - 'File was not able to be retrieved when checked on 2025-08-14: HTTP 401 error
    when accessing file'
  - 'File was not able to be retrieved when checked on 2025-08-19: HTTP 401 error
    when accessing file'
- category: Product
