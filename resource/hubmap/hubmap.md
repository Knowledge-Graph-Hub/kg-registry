...
- category: Product
  ...
  - File was not able to be retrieved when checked on 2026-03-30_ HTTP 401 error when
    accessing file
  - 'File was not able to be retrieved when checked on 2026-04-16: HTTP 401 error
    when accessing file'
  - 'File was not able to be retrieved when checked on 2026-04-22: HTTP 401 error
    when accessing file'
- category: Product
