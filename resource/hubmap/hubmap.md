...
- category: Product
  ...
  - File was not able to be retrieved when checked on 2026-02-20_ HTTP 401 error when
    accessing file
  - File was not able to be retrieved when checked on 2026-02-21_ HTTP 401 error when
    accessing file
  - 'File was not able to be retrieved when checked on 2026-02-22: HTTP 401 error
    when accessing file'
- category: Product
