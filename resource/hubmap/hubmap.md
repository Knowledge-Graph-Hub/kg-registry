...
- category: Product
  ...
  warnings:
  - File was not able to be retrieved when checked on 2026-03-08_ HTTP 401 error when
    accessing file
  - File was not able to be retrieved when checked on 2026-03-11_ HTTP 401 error when
    accessing file
  - 'File was not able to be retrieved when checked on 2026-03-30: HTTP 401 error
    when accessing file'
- category: Product
