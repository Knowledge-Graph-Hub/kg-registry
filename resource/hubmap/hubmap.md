...
- category: Product
  ...
  warnings:
  - File was not able to be retrieved when checked on 2025-11-26_ HTTP 401 error when
    accessing file
  - File was not able to be retrieved when checked on 2025-12-04_ HTTP 401 error when
    accessing file
  - 'File was not able to be retrieved when checked on 2025-12-04: HTTP 401 error
    when accessing file'
- category: Product
