...
- category: Product
  ...
  warnings:
  - File was not able to be retrieved when checked on 2025-12-05_ HTTP 401 error when
    accessing file
  - File was not able to be retrieved when checked on 2025-12-07_ HTTP 401 error when
    accessing file
  - 'File was not able to be retrieved when checked on 2025-12-08: HTTP 401 error
    when accessing file'
- category: Product
