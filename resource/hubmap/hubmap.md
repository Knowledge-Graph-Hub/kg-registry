...
- category: Product
  ...
  warnings:
  - File was not able to be retrieved when checked on 2025-12-15_ HTTP 401 error when
    accessing file
  - File was not able to be retrieved when checked on 2025-12-17_ HTTP 401 error when
    accessing file
  - 'File was not able to be retrieved when checked on 2025-12-17: HTTP 401 error
    when accessing file'
- category: Product
