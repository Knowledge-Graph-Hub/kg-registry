...
- category: Product
  ...
  warnings:
  - File was not able to be retrieved when checked on 2026-01-28_ HTTP 401 error when
    accessing file
  - File was not able to be retrieved when checked on 2026-01-30_ HTTP 401 error when
    accessing file
  - 'File was not able to be retrieved when checked on 2026-02-04: HTTP 401 error
    when accessing file'
- category: Product
