...
- category: Product
  ...
  warnings:
  - File was not able to be retrieved when checked on 2025-12-17_ HTTP 401 error when
    accessing file
  - File was not able to be retrieved when checked on 2025-12-18_ HTTP 401 error when
    accessing file
  - 'File was not able to be retrieved when checked on 2025-12-18: HTTP 401 error
    when accessing file'
- category: Product
