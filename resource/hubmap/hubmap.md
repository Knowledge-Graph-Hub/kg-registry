...
- category: Product
  ...
  warnings:
  - File was not able to be retrieved when checked on 2025-11-17_ HTTP 401 error when
    accessing file
  - File was not able to be retrieved when checked on 2025-11-19_ HTTP 401 error when
    accessing file
  - 'File was not able to be retrieved when checked on 2025-11-19: HTTP 401 error
    when accessing file'
- category: Product
