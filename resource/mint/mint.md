...
- category: Product
  ...
  - File was not able to be retrieved when checked on 2025-12-04_ Timeout connecting
    to URL
  - File was not able to be retrieved when checked on 2026-01-30_ HTTP 500 error when
    accessing file
  - 'File was not able to be retrieved when checked on 2026-02-04: HTTP 500 error
    when accessing file'
- category: Product
