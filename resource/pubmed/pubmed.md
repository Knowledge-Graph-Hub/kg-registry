...
- category: GraphProduct
  ...
  - File was not able to be retrieved when checked on 2026-01-06_ HTTP 418 error when
    accessing file
  - 'File was not able to be retrieved when checked on 2026-01-15: HTTP 418 error
    when accessing file'
- category: Product
...
- category: GraphProduct
  ...
  - File was not able to be retrieved when checked on 2026-01-06_ FTP error_ timed
    out
  - 'File was not able to be retrieved when checked on 2026-01-15: FTP error: timed
    out'
