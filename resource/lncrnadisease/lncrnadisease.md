...
description: LncRNADisease is a database of experimentally supported and predicted
  long non-coding RNA (lncRNA) and disease associations. It also curates lncRNA interactions
  at various molecular levels, including with proteins, RNA, miRNA, and DNA, to support
  studies of lncRNA function in disease.
domains:
- genomics
- clinical
