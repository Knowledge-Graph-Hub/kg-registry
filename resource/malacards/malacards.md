...
description: MalaCards is a comprehensive, searchable database integrating information about human diseases from 78 data sources. It provides integrated disease annotations including genes, symptoms, drugs, mutations, publications, clinical trials, and pathways for over 22,000 human disorders.
domains:
  - health
  - clinical
  - genomics
...
products:
  - category: GraphicalInterface
    description: Searchable web interface for exploring human diseases with integrated data on genes, symptoms, drugs, mutations, clinical trials and more.
    format: http
    id: malacards.portal
  ...
  - category: GraphicalInterface
    description: Browse diseases by global categories (cancer, genetic, rare, etc.) and anatomical categories (neuronal, cardiovascular, etc.).
    format: http
