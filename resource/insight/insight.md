...
description: INSIGHT is an integrative knowledge graph resource designed to support
  translational and clinical informatics by linking heterogeneous biomedical entities
  (genes, variants, diseases, phenotypes, pathways, drugs, and clinical concepts)
...
- View the automated evaluation: [insight automated evaluation](insight_eval_automated.html)
