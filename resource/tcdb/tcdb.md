...
description: A curated classification database of membrane transport proteins, organized by the Transporter Classification (TC) system and supporting sequence- and family-level exploration.
domains:
  - biological systems
  - proteomics
...
products:
  - category: GraphicalInterface
    description: Main web interface for browsing transporter families, proteins, and curated annotations.
    format: http
    id: tcdb.portal
    name: TCDB Portal
  ...
  - category: Product
    description: Tab-delimited table mapping TC systems to substrate identifiers. The URL ends in .py, but this endpoint serves data, not Python source code.
    format: tsv
  ...
  - category: Product
    description: Tab-delimited table with TC family definitions. The URL ends in .py, but this endpoint serves data, not Python source code.
    format: tsv
  ...
  - category: Product
    description: Tab-delimited table mapping sequence accessions to TC identifiers. The URL ends in .py, but this endpoint serves data, not Python source code.
    format: tsv
  ...
  - category: Product
    description: Tab-delimited table mapping systems, subfamilies, and families to superfamilies. The URL ends in .py, but this endpoint serves data, not Python source code.
    format: tsv
  ...
  - category: Product
    description: Tab-delimited table mapping protein accessions to TC identifiers. The URL ends in .py, but this endpoint serves data, not Python source code.
    format: tsv
    ...
    warnings:
      ...
      - File was not able to be retrieved when checked on 2026-03-30_ No Content-Length header found
  - category: Product
    description: Tab-delimited annotation mapping table for TC systems. The URL ends in .py, but this endpoint serves data, not Python source code.
    format: tsv
    id: tcdb.download.go
  ...
  - category: Product
    ...
    warnings:
      ...
      - File was not able to be retrieved when checked on 2026-03-30_ No Content-Length header found
  - category: Product
    description: Tab-delimited protein family mapping table for TC systems. The URL ends in .py, but this endpoint serves data, not Python source code.
    format: tsv
