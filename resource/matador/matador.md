...
description: MATADOR (Manually Annotated Targets and Drugs Online Resource) is a manually curated database of drug-target relationships developed at EMBL. Unlike resources limited to direct binding, MATADOR captures both direct (binding) and indirect (e.g., metabolic or signaling) drug-target interactions for proteins and small molecules. It was distributed alongside SuperTarget and serves as an upstream source for downstream knowledge graphs such as PharmDB.
domains:
  - pharmacology
  - drug discovery
...
products:
  - category: DocumentationProduct
    description: Publication describing SuperTarget and MATADOR resources for exploring drug-target relationships, the primary stable reference for the MATADOR dataset.
    format: http
