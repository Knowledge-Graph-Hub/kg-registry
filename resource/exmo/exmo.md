...
- category: GraphProduct
  compression: targz
  description: KGX TSV transform of Exercise Medicine Ontology (EXMO), produced by
    KG-Bioportal from the BioPortal submission. The archive contains EXMO_nodes.tsv
    and EXMO_edges.tsv.
  edge_count: 3466
  format: kgx
