...
description: SIMAP (Similarity Matrix of Proteins) is a protein sequence similarity resource historically used as an upstream source in integrative protein interaction systems.
domains:
  - proteomics
  - genomics
  - biological systems
