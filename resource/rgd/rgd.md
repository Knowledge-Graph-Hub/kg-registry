...
description: The Rat Genome Database (RGD) curates and integrates rat genomic and
  ...
  in rats. RGD contains comprehensive data on genes, QTLs, strains, and genomic elements
  for rat, human, mouse, chinchilla, dog, cat, pig, bonobo, squirrel, green monkey,
  and naked mole rat. The database includes extensive ontology annotations (RDO, CMO,
  ChEBI, EFO, GO, HP, MMO, MP, PW, RS, VT, XCO), variant information, pathway data,
