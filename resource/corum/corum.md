...
products:
  - category: Product
    ...
    warnings:
      ...
      - 'File was not able to be retrieved when checked on 2026-05-09: Error connecting to URL: HTTPSConnectionPool(host=''mips.helmholtz-muenchen.de'', port=443): Max retries exceeded with url: /corum/download/ (Caused by SSLError(SSLCertVerificationError(1, ''[SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed: unable to get local issuer certificate (_ssl.c:1000)'')))'
    original_source:
      - source: corum
