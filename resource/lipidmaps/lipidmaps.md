...
- category: Product
  ...
  warnings:
  - 'File was not able to be retrieved when checked on 2026-06-25: HTTP 520 error
    when accessing file'
  - 'File was not able to be retrieved when checked on 2026-06-26: HTTP 520 error
    when accessing file'
