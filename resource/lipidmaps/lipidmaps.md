...
- category: Product
  ...
  warnings:
  - 'File was not able to be retrieved when checked on 2026-06-22: HTTP 520 error
    when accessing file'
  - 'File was not able to be retrieved when checked on 2026-06-24: HTTP 520 error
    when accessing file'
