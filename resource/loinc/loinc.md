...
- category: DataModelProduct
  ...
  warnings:
  - 'File was not able to be retrieved when checked on 2025-08-25: HTTP 503 error
    when accessing file'
  - 'File was not able to be retrieved when checked on 2025-08-26: HTTP 503 error
    when accessing file'
- category: DataModelProduct
