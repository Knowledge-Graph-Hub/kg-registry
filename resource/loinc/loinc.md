...
- category: DataModelProduct
  ...
  warnings:
  - File was not able to be retrieved when checked on 2025-11-10_ HTTP 503 error when
    accessing file
  - File was not able to be retrieved when checked on 2025-11-11_ HTTP 503 error when
    accessing file
  - 'File was not able to be retrieved when checked on 2025-11-13: HTTP 503 error
    when accessing file'
- category: DataModelProduct
