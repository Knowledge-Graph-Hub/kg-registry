...
- category: Product
  ...
  - File was not able to be retrieved when checked on 2025-11-06_ Timeout connecting
    to URL
  - File was not able to be retrieved when checked on 2025-11-09_ Timeout connecting
    to URL
  - 'File was not able to be retrieved when checked on 2025-11-10: Timeout connecting
    to URL'
