...
products:
  - category: GraphicalInterface
    description: Web-based search interface for exploring protein-protein interactions by journal article, experimental evidence, or protein identifiers
    id: dip.search
  ...
  - category: Product
    description: Complete DIP dataset and specialized subsets available for download in PSI-MI formats (registration required)
    format: psi_mi_mitab
    id: dip.downloads
    name: DIP Data Downloads
    product_url: https://dip.doe-mbi.ucla.edu/dip/Download.cgi
    warnings:
      - File was not able to be retrieved when checked on 2026-03-30_ Error connecting to URL_ HTTPSConnectionPool(host='dip.doe-mbi.ucla.edu', port=443)_ Max retries exceeded with url_ /dip/Download.cgi (Caused by SSLError(SSLCertVerificationError(1, '[SSL_ CERTIFICATE_VERIFY_FAILED] certificate verify failed_ unable to get local issuer certificate (_ssl.c_1028)')))
      ...
      - File was not able to be retrieved when checked on 2026-01-15_ Error connecting to URL_ HTTPSConnectionPool(host='dip.doe-mbi.ucla.edu', port=443)_ Max retries exceeded with url_ /dip/Download.cgi (Caused by SSLError(SSLCertVerificationError(1, '[SSL_ CERTIFICATE_VERIFY_FAILED] certificate verify failed_ unable to get local issuer certificate (_ssl.c_1017)')))
      - 'File was not able to be retrieved when checked on 2026-05-04: Error connecting to URL: HTTPSConnectionPool(host=''dip.doe-mbi.ucla.edu'', port=443): Max retries exceeded with url: /dip/Download.cgi (Caused by SSLError(SSLCertVerificationError(1, ''[SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed: unable to get local issuer certificate (_ssl.c:1000)'')))'
      - 'File was not able to be retrieved when checked on 2026-04-15: Error connecting to URL: HTTPSConnectionPool(host=''dip.doe-mbi.ucla.edu'', port=443): Max retries exceeded with url: /dip/Download.cgi (Caused by SSLError(SSLCertVerificationError(1, ''[SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed: unable to get local issuer certificate (_ssl.c:1028)'')))'
      - 'File was not able to be retrieved when checked on 2026-05-09: Error connecting to URL: HTTPSConnectionPool(host=''dip.doe-mbi.ucla.edu'', port=443): Max retries exceeded with url: /dip/Download.cgi (Caused by SSLError(SSLCertVerificationError(1, ''[SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed: unable to get local issuer certificate (_ssl.c:1000)'')))'
    original_source:
      - source: dip
        relation_type: prov:hadPrimarySource
  - category: Product
