...
- category: DocumentationProduct
  description: Translator wiki documentation for the SRI Ontology Service and Ontology
    KP usage.
  format: http
  id: ontology-kp.docs
...
- category: ProcessProduct
  description: UberGraph source repository used to support ontology reasoning and
    integrated ontology queries.
  format: http
