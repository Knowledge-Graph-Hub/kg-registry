...
description: RLIMS-P, the Rule-based Literature Mining System for Protein Phosphorylation, is a biomedical text-mining system that extracts protein kinases, substrates, phosphorylation sites, and evidence text from phosphorylation-related literature.
domains:
  - biomedical
  - literature
  - proteomics
...
products:
  ...
  - category: DocumentationProduct
    description: Annotation guidelines used with RLIMS-P protein phosphorylation literature-mining tasks.
    format: http
