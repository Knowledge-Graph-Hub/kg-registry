...
description: The Pseudogene Ontology (PGO) is an ontology for classifying and annotating
  ...
  genomic features. Pseudogenes are genomic loci that resemble functional genes but
  have lost their coding capacity through various mechanisms including frameshift
  mutations, premature stop codons, or loss of regulatory elements. PGO provides a
  structured vocabulary for describing different types of pseudogenes (processed,
