...
- category: GraphProduct
  ...
  description: KGX TSV transform of Alzheimer's Disease Ontology (ADO), produced by
    KG-Bioportal from the BioPortal submission. The archive contains ADO_nodes.tsv
    and ADO_edges.tsv.
  edge_count: 6185
  format: kgx
  id: ado.kg-bioportal
...
- authors:
  ...
  id: https://www.ncbi.nlm.nih.gov/pubmed/23830913
  journal: Alzheimers Dement
  preferred: true
  title: 'ADO: a disease ontology representing the domain knowledge specific to Alzheimer''s
    disease'
  year: '2014'
