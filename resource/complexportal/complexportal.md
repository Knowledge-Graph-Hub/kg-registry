...
- category: Product
  description: Bacillus subtilis complexes dataset from Complex Portal in ComplexTAB
    format
  format: tsv
...
- category: Product
  description: Arabidopsis thaliana complexes dataset from Complex Portal in ComplexTAB
    format
  format: tsv
