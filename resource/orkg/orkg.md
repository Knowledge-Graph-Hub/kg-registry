...
products:
  - category: GraphicalInterface
    description: Web portal for browsing papers, creating structured research descriptions, and comparing research contributions in ORKG.
    format: http
    id: orkg.portal
  ...
  - category: ProgrammingInterface
    description: Public REST API for programmatic access to ORKG resources, comparisons, papers, and other structured scholarly content.
    format: http
    id: orkg.api
    is_public: true
    name: ORKG REST API
  ...
  - category: DocumentationProduct
    description: Static reference documentation for the ORKG REST API published via GitLab Pages.
    format: http
    id: orkg.api-docs
  ...
  - category: DocumentationProduct
    description: Official ORKG documentation covering tutorials, reference material, and REST API model documentation.
    format: http
    id: orkg.docs
