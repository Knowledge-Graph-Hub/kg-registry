...
description: Clinical Trials Knowledge Provider (CTKP) is a Translator knowledge provider maintained by the Multiomics Provider that exposes clinical trial-derived associations from ClinicalTrials.gov (via AACT), including trial interventions, conditions, and related biomedical entities.
domains:
  - clinical
  - health
  - translational
...
products:
  ...
  - category: DocumentationProduct
    description: Translator wiki documentation for Clinical Trials KP, including source and access details.
    format: http
    id: ctkp.docs
