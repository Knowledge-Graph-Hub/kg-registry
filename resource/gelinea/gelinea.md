...
description: Gene-List Network Enrichment Analysis (GeLiNEA) is a computational tool
  that evaluates the significance of connections between a gene list (e.g., from screening
  experiments) and curated gene sets (e.g., MSigDB) within protein-protein association
  networks (e.g., STRING). It uses a null model of degree-preserving random gene lists
  to assess statistical significance of network connections, supporting pathway enrichment
  analysis and functional interpretation of experimental gene lists.
domains:
- genomics
- systems biology
- biomedical
