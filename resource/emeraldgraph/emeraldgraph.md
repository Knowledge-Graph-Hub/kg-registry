...
description: EmeraldGraph is the domain-specific knowledge graph used by EmeraldMind,
  a knowledge graph-augmented framework for greenwashing detection. It is built from
  corporate environmental, social, and governance reports to represent sustainability
  claims, organizations, goals, initiatives, metrics, evidence, and related relationships
  for retrieval-augmented claim assessment.
domains:
- environment
...
- category: DataModelProduct
  description: EmeraldGraph schema definitions used by the construction pipeline to
    validate relationship and classification logic.
  format: json
