...
description: Database of metabolic potential predictions for microbial organisms, providing computational inferences about metabolic capabilities based on genomic and metagenomic data.
domains:
  - microbiology
  - systems biology
  - genomics
