...
description: Aggregated, transformed graph datasets distributed by the NCATS Translator
  program via the STARs release site. Each package provides a KGX graph built from
  an upstream source and normalized with Translator pipelines.
domains:
- biomedical
- clinical
- translational
