...
description: The Eukaryotic Promoter Database (EPD) is an annotated, non-redundant
  collection of experimentally validated eukaryotic POL II promoters. Its EPDnew components
  provide high-quality, automatically derived promoter collections for selected organisms,
  with tools for promoter analysis.
domains:
- genomics
- systems biology
...
- category: GraphicalInterface
  description: Web interface for browsing and searching experimentally validated eukaryotic
    promoters.
  format: http
  id: epd.site
  is_public: true
...
- authors:
  ...
  preferred: true
  title: 'The eukaryotic promoter database: expansion of EPDnew and new promoter analysis
    tools'
  year: '2015'
---
