...
- category: Organization
  ...
  id: ncbi
  label: National Center for Biotechnology Information (NCBI), U.S. National Library of Medicine
...
description: dbVar is NCBI's public archive of human genomic structural variation,
  ...
  variant calls together with their genomic placements, supporting evidence, and
  associated clinical assertions, and exchanges data with the European DGVa archive.
  dbVar provides a web portal for searching and browsing variants and regions, as
  well as bulk FTP downloads of variant call and region files in multiple formats.
  It serves as an upstream source for integrative knowledge graphs such as GenomicKB.
domains:
- genomics
- clinical
- biomedical
