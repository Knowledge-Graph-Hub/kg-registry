...
- category: DocumentationProduct
  ...
  warnings:
  - 'File was not able to be retrieved when checked on 2026-09-21: HTTP 204 error
    when accessing file'
  - 'File was not able to be retrieved when checked on 2026-09-23: HTTP 204 error
    when accessing file'
