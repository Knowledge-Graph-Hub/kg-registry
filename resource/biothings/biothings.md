...
- category: DocumentationProduct
  ...
  warnings:
  - 'File was not able to be retrieved when checked on 2026-09-02: HTTP 204 error
    when accessing file'
  - 'File was not able to be retrieved when checked on 2026-09-03: HTTP 204 error
    when accessing file'
