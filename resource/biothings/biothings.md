...
- category: DocumentationProduct
  ...
  warnings:
  - 'File was not able to be retrieved when checked on 2026-06-18: HTTP 204 error
    when accessing file'
  - 'File was not able to be retrieved when checked on 2026-06-22: HTTP 204 error
    when accessing file'
