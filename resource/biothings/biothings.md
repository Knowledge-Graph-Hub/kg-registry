...
- category: DocumentationProduct
  ...
  warnings:
  - 'File was not able to be retrieved when checked on 2026-08-06: HTTP 204 error
    when accessing file'
  - 'File was not able to be retrieved when checked on 2026-08-12: HTTP 204 error
    when accessing file'
