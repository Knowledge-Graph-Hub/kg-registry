...
- category: DocumentationProduct
  ...
  warnings:
  - 'File was not able to be retrieved when checked on 2026-06-16: HTTP 204 error
    when accessing file'
  - 'File was not able to be retrieved when checked on 2026-06-17: HTTP 204 error
    when accessing file'
