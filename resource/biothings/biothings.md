...
- category: DocumentationProduct
  ...
  warnings:
  - 'File was not able to be retrieved when checked on 2026-06-26: HTTP 204 error
    when accessing file'
  - 'File was not able to be retrieved when checked on 2026-06-27: HTTP 204 error
    when accessing file'
