...
- category: GraphProduct
  compression: targz
  description: KGX TSV transform of Clinical Measurement Ontology (CMO), produced
    by KG-Bioportal from the BioPortal submission. The archive contains CMO_nodes.tsv
    and CMO_edges.tsv.
  edge_count: 5013
  format: kgx
  id: cmo.kg-bioportal
