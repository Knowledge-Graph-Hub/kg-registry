...
description: The Conserved Domain Database (CDD) is a resource for the annotation
  of functional units in proteins. It provides a collection of well-annotated multiple
...
- category: GraphicalInterface
  description: Web interface for browsing and searching conserved protein domain models.
  format: http
  id: cdd.site
  is_public: true
  name: CDD Website
...
- authors:
  ...
  - Marc Gwadz
  - Shennan Lu
  - "Gabriele\_H Marchler"
  - "James\_S Song"
  - Narmada Thanki
  - "Roxanne\_A Yamashita"
  - Mingzhang Yang
  - Dachuan Zhang
  - Chanjuan Zheng
  - "Christopher\_J Lanczycki"
  - Aron Marchler-Bauer
