---
category: Product
description: HOCOMOCO v11 full collection human mononucleotide PWMs (flat text), including
  secondary motif subtypes
format: txt
...
- File was not able to be retrieved when checked on 2026-08-17_ HTTP 404 error when
  accessing file
- File was not able to be retrieved when checked on 2026-07-30_ No Content-Length
  header found
