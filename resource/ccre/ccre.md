...
description: The ENCODE Registry of candidate cis-Regulatory Elements (cCREs) is a
  curated annotation of regulatory regions in the human and mouse genomes derived from
  ENCODE and Roadmap Epigenomics data. Each cCRE is classified by its biochemical
...
products:
  - category: GraphicalInterface
    description: SCREEN (Search Candidate cis-Regulatory Elements by ENCODE) web portal
      for browsing and searching the registry of candidate cis-Regulatory Elements
