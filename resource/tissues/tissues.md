...
products:
  - category: GraphicalInterface
    description: Web interface for searching and visualizing tissue expression data with schematic human body visualization
    format: http
    id: tissues.web
  ...
  - category: Product
    ...
    warnings:
      ...
      - 'File was not able to be retrieved when checked on 2026-05-29: Timeout connecting to URL'
  - category: Product
