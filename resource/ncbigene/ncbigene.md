...
description: NCBI Gene integrates information from a wide range of species. A record may include nomenclature, Reference Sequences (RefSeqs), maps, pathways, variations, phenotypes, and links to genome-, phenotype-, and locus-specific resources worldwide.
domains:
  - biological systems
...
license:
  ...
  label: CC0 1.0
name: NCBI Gene
repository: https://ftp.ncbi.nlm.nih.gov/gene/
products:
  - category: MappingProduct
    compression: gzip
    description: Gene to accession mapping data providing links between gene records and nucleotide/protein sequence accessions
    format: tsv
    ...
    original_source:
      - relation_type: prov:hadPrimarySource
        source: ncbigene
    product_file_size: 4531690948
    product_url: https://ftp.ncbi.nlm.nih.gov/gene/DATA/gene2accession.gz
  - category: MappingProduct
    compression: gzip
    description: Gene to Ensembl mapping data providing cross-references between NCBI Gene and Ensembl gene identifiers
    format: tsv
  ...
  - category: Product
    ...
    original_source:
      - relation_type: prov:hadPrimarySource
        source: ncbigene
    product_file_size: 159570007
    product_url: https://ftp.ncbi.nlm.nih.gov/gene/DATA/gene_history.gz
  - category: Product
    compression: gzip
    description: Comprehensive gene information including symbols, names, locations, and other metadata
    format: tsv
    ...
    original_source:
      - relation_type: prov:hadPrimarySource
        source: ncbigene
    product_file_size: 1537004325
    product_url: https://ftp.ncbi.nlm.nih.gov/gene/DATA/gene_info.gz
  - category: Product
    compression: gzip
  ...
  - category: Product
    ...
    original_source:
      - relation_type: prov:hadPrimarySource
        source: ncbigene
    product_file_size: 126501789
    product_url: https://ftp.ncbi.nlm.nih.gov/gene/DATA/gene_orthologs.gz
  - category: MappingProduct
    compression: gzip
  ...
  - category: Product
    ...
    original_source:
      - relation_type: prov:hadPrimarySource
        source: ncbigene
    product_file_size: 22367944
    product_url: https://ftp.ncbi.nlm.nih.gov/gene/DATA/gene_summary.gz
  - category: MappingProduct
  ...
  - category: ProgrammingInterface
    ...
    secondary_source:
      ...
      - relation_type: prov:wasInformedBy
        source: ncbitaxon
  - category: Product
    description: Current comprehensive GENCODE gene annotations for the human GRCh38.p14 genome assembly in GTF format
    format: gff
    ...
    secondary_source:
      ...
      - relation_type: prov:wasInformedBy
        source: ncbigene
  - category: Product
    description: Current comprehensive GENCODE gene annotations for the mouse GRCm39 genome assembly in GTF format
    format: gff
  ...
  - category: Product
    ...
    secondary_source:
      ...
      - relation_type: prov:wasInformedBy
        source: ncbigene
  - category: Product
    description: BioThings GTRx association collection built from Genome-to-Treatment source records; the 20220802 build reports 695 association records
    format: mixed
    id: gtrx.data
