...
- category: Product
  ...
  - 'File was not able to be retrieved when checked on 2026-09-16: HTTP 502 error
    when accessing file'
  - 'File was not able to be retrieved when checked on 2026-09-21: HTTP 502 error
    when accessing file'
- category: ProgrammingInterface
