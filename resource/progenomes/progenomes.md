...
description: A large-scale microbial genome resource with consistent annotation, species clustering, and downloadable representative genome and protein datasets.
domains:
  - genomics
  - microbiology
  - biological systems
