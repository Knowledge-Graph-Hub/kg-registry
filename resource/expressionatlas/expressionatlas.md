...
- category: Product
  ...
  - File was not able to be retrieved when checked on 2026-03-30_ HTTP 500 error when
    accessing file
  - 'File was not able to be retrieved when checked on 2026-06-01: HTTP 500 error
    when accessing file'
  - 'File was not able to be retrieved when checked on 2026-05-20: Timeout connecting
    to URL'
  - 'File was not able to be retrieved when checked on 2026-06-02: HTTP 500 error
    when accessing file'
- category: Product
