...
- category: Product
  ...
  warnings:
  - File was not able to be retrieved when checked on 2026-02-26_ HTTP 500 error when
    accessing file
  - File was not able to be retrieved when checked on 2026-03-08_ HTTP 500 error when
    accessing file
  - 'File was not able to be retrieved when checked on 2026-03-11: HTTP 500 error
    when accessing file'
- category: Product
