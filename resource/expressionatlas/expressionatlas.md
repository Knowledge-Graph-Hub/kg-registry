...
- category: Product
  ...
  warnings:
  - File was not able to be retrieved when checked on 2025-11-04_ HTTP 500 error when
    accessing file
  - File was not able to be retrieved when checked on 2025-11-05_ HTTP 500 error when
    accessing file
  - 'File was not able to be retrieved when checked on 2025-11-06: HTTP 500 error
    when accessing file'
- category: Product
