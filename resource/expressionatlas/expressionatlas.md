...
products:
  ...
  - category: Product
    ...
    warnings:
      - File was not able to be retrieved when checked on 2026-03-30_ HTTP 500 error when accessing file
      - 'File was not able to be retrieved when checked on 2026-05-04: HTTP 500 error when accessing file'
      - 'File was not able to be retrieved when checked on 2026-05-09: HTTP 500 error when accessing file'
    original_source:
      - source: expressionatlas
        relation_type: prov:hadPrimarySource
  - category: Product
