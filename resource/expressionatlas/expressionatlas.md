...
- category: Product
  ...
  warnings:
  - File was not able to be retrieved when checked on 2026-01-02_ HTTP 500 error when
    accessing file
  - File was not able to be retrieved when checked on 2026-01-03_ HTTP 500 error when
    accessing file
  - 'File was not able to be retrieved when checked on 2026-01-03: HTTP 500 error
    when accessing file'
- category: Product
