...
- category: Product
  ...
  - File was not able to be retrieved when checked on 2026-03-30_ HTTP 500 error when
    accessing file
  - 'File was not able to be retrieved when checked on 2026-04-10: HTTP 500 error
    when accessing file'
  - 'File was not able to be retrieved when checked on 2026-04-15: HTTP 500 error
    when accessing file'
- category: Product
