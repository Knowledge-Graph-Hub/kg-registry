...
description: The European Medicines Agency is the European Union agency responsible
  for scientific evaluation, supervision, and safety monitoring of medicines in the
  EU and EEA, including public medicine pages, EPARs, regulatory data, and pharmacovigilance
  resources.
domains:
- pharmacology
- clinical
...
- category: Product
  description: EMA downloadable medicine data tables covering human medicines, veterinary
    medicines, opinions for medicines used outside the EU, and herbal medicines.
  format: mixed
...
- category: Product
  description: Public data from the EMA Article 57 database on all medicines authorised
