...
- category: Product
  ...
  warnings:
  - 'File was not able to be retrieved when checked on 2026-05-29: HTTP 416 error
    when accessing file'
  - 'File was not able to be retrieved when checked on 2026-05-31: HTTP 416 error
    when accessing file'
