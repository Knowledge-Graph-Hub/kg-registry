...
- category: DocumentationProduct
  ...
  warnings:
  - 'File was not able to be retrieved when checked on 2026-08-12: HTTP 498 error
    when accessing file'
  - 'File was not able to be retrieved when checked on 2026-08-17: HTTP 498 error
    when accessing file'
- category: DocumentationProduct
