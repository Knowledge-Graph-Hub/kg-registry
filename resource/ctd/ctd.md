...
products:
  ...
  - category: GraphProduct
    compression: targz
    description: KGX JSON-Lines Distribution of KG-Monarch (Edges), distributed within the combined monarch-kg.jsonl.tar.gz bundle containing both nodes and edges.
    edge_count: 15211571
    format: kgx-jsonl
  ...
  - category: GraphProduct
    compression: targz
    description: KGX JSON-Lines Distribution of KG-Monarch (Nodes), distributed within the combined monarch-kg.jsonl.tar.gz bundle containing both nodes and edges.
    edge_count: 15211571
    format: kgx-jsonl
