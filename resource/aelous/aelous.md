...
description: AELOUS provides adverse event report data processed from spontaneous
  reporting systems for large-scale pharmacovigilance analysis.
domains:
- biomedical
- pharmacology
- health
...
AELOUS is a data source used for adverse event mining and pharmacovigilance studies.