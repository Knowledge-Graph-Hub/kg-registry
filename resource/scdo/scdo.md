...
- category: GraphProduct
  compression: targz
  description: KGX TSV transform of Sickle Cell Disease Ontology (SCDO), produced
    by KG-Bioportal from the BioPortal submission. The archive contains SCDO_nodes.tsv
    and SCDO_edges.tsv.
  edge_count: 7286
  format: kgx
