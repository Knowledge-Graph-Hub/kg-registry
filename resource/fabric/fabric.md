...
description: The FABRIC (Functional Alteration Bias Recovery In Coding regions) Cancer
  Portal is a catalogue of human protein-coding genes ranked by the strength of positive
  selection acting on them in cancer. It quantifies, for each gene, the bias toward
  functional alteration of its protein across large somatic mutation datasets.
domains:
- genomics
- biomedical
