...
products:
  ...
  - category: Product
    ...
    warnings:
      - 'File was not able to be retrieved when checked on 2026-05-28: HTTP 403 error when accessing file'
      - 'File was not able to be retrieved when checked on 2025-09-04: Timeout connecting to URL'
      - 'File was not able to be retrieved when checked on 2026-05-29: HTTP 403 error when accessing file'
  - category: Product
