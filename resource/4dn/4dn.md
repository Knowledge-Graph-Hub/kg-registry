...
description: The 4D Nucleome (4DN) Network aims to understand the principles underlying
  nuclear organization in space and time (the 4th dimension). The 4DN Data Portal provides
  a platform to search, visualize, and download nucleomics data generated by the 4DN Network
...
license:
  name: Various
  url: https://data.4dnucleome.org/help/user-guide/faq#downloading-and-using-data-from-the-4dn-data-portal
