...
- category: ProcessProduct
  description: R package used to dynamically generate OMOP CDM documentation and
    DDL scripts for supported SQL dialects
  format: http
...
- category: ProcessProduct
  description: Application for displaying results from Achilles and Data Quality
    Dashboard to support data quality and characterization research
  format: http
  id: ohdsi.ares
  name: ARES
  original_source:
