...
description: The Colorado Richly Annotated Full-Text (CRAFT) Corpus is a manually
  annotated corpus of full-text biomedical journal articles. It provides concept annotations
  against multiple biomedical ontologies along with syntactic and coreference annotations,
  serving as a gold-standard resource for biomedical natural language processing.
domains:
- literature
- biomedical
