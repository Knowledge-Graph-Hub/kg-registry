...
description: The UCSC Genome Browser is a web-based tool and data resource providing
  access to reference genome assemblies and an extensive collection of aligned annotation
  tracks for human and many other organisms. It supports interactive visualization,
