...
- category: DocumentationProduct
  ...
  product_url: https://cohd.io/api
  warnings:
  - File was not able to be retrieved when checked on 2026-01-23_ HTTP 502 error when
    accessing file
  - File was not able to be retrieved when checked on 2026-01-28_ HTTP 502 error when
    accessing file
  - 'File was not able to be retrieved when checked on 2026-01-30: HTTP 502 error
    when accessing file'
