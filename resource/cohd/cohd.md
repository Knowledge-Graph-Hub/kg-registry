...
- category: DocumentationProduct
  ...
  product_url: https://cohd.io/api
  warnings:
  - File was not able to be retrieved when checked on 2026-03-08_ HTTP 502 error when
    accessing file
  - File was not able to be retrieved when checked on 2026-03-11_ HTTP 502 error when
    accessing file
  - 'File was not able to be retrieved when checked on 2026-03-30: HTTP 502 error
    when accessing file'
