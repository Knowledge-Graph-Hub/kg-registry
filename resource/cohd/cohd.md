...
- category: DocumentationProduct
  ...
  - File was not able to be retrieved when checked on 2026-02-20_ HTTP 502 error when
    accessing file
  - File was not able to be retrieved when checked on 2026-02-21_ HTTP 502 error when
    accessing file
  - 'File was not able to be retrieved when checked on 2026-02-22: HTTP 502 error
    when accessing file'
