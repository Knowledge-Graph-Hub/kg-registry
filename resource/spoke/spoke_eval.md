...
<tr><td>multi_access_options_text</td><td style="background-color:#d4edda;">yes</td></tr>
<tr><td>multi_access_options</td><td style="background-color:#d4edda;">Y</td></tr>
<tr><td>sourcecode_available_text</td><td style="background-color:#f8d7da;">no</td></tr>
...
<table class="table table-striped">
<thead><tr><th>Question</th><th>Answer</th></tr></thead><tbody>
<tr><td>source_list_provided_text</td><td style="background-color:#d4edda;">yes in supplemental and on website</td></tr>
<tr><td>source_list_provided</td><td style="background-color:#d4edda;">Y</td></tr>
<tr><td>source_versions_info_text</td><td style="background-color:#d4edda;">yes; pulled each week</td></tr>
...
<tr><td>triples_source_details_text</td><td style="background-color:#d4edda;">yes; some for instance specifies PPI for humans comes from STRING; human disease ontology provides disease associated gene</td></tr>
...
<table class="table table-striped">
<thead><tr><th>Question</th><th>Answer</th></tr></thead><tbody>
<tr><td>bio_usable_data_text</td><td style="background-color:#d4edda;">yes no custom data transforms that are KG specific</td></tr>
<tr><td>bio_usable_data</td><td style="background-color:#d4edda;">Y</td></tr>
<tr><td>resolvable_ids_text</td><td style="background-color:#d4edda;">yes uses Ensembl</td></tr>
<tr><td>resolvable_ids</td><td style="background-color:#d4edda;">Y</td></tr>
<tr><td>construction_docs_text</td><td style="background-color:#d4edda;">yes edge and node types specified with source</td></tr>
<tr><td>construction_docs</td><td style="background-color:#d4edda;">Y</td></tr>
<tr><td>transform_docs_text</td><td style="background-color:#d4edda;">yes; data is downloaded and integrated as is</td></tr>
...
<tr><td>kg_contact_info_text</td><td style="background-color:#d4edda;">yes email provided</td></tr>
<tr><td>kg_contact_info</td><td style="background-color:#d4edda;">Y</td></tr>
<tr><td>updated_annually_text</td><td style="background-color:#d4edda;">yes updated weekly according to paper</td></tr>
...
<table class="table table-striped">
<thead><tr><th>Question</th><th>Answer</th></tr></thead><tbody>
<tr><td>use_case_provided_text</td><td style="background-color:#f8d7da;">no</td></tr>
...
<tr><td>defined_scope_text</td><td style="background-color:#d4edda;">yes; biomedical applications such as drug reuposing, disease prediction, embedding EHR data</td></tr>
