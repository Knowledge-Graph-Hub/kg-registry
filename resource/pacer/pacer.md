...
- category: GraphProduct
  description: SCALES knowledge graph of U.S. federal court records, derived from
    PACER data and served via the SCALES SPARQL and Triple Pattern Fragments endpoints.
  format: ttl
  id: scales.graph
