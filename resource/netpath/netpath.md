...
- category: Product
  ...
  warnings:
  - 'File was not able to be retrieved when checked on 2026-09-01: HTTP 503 error
    when accessing file'
  - 'File was not able to be retrieved when checked on 2026-09-02: HTTP 503 error
    when accessing file'
- category: Product
  compression: gzip
