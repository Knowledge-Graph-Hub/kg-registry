...
- category: Product
  ...
  warnings:
  - 'File was not able to be retrieved when checked on 2026-07-28: HTTP 503 error
    when accessing file'
  - 'File was not able to be retrieved when checked on 2026-07-30: HTTP 503 error
    when accessing file'
- category: Product
  compression: gzip
