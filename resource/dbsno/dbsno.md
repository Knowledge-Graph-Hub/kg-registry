...
- category: Product
  ...
  - relation_type: prov:wasDerivedFrom
    source: uniprot
  warnings:
  - 'File was not able to be retrieved when checked on 2026-09-16: HTTP 500 error
    when accessing file'
  ...
  - 'File was not able to be retrieved when checked on 2026-09-21: HTTP 500 error
    when accessing file'
