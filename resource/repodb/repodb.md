...
description: RepoDB is a standard dataset of drug repositioning successes and failures  that can be used to fairly and reproducibly benchmark computational  repositioning methods. The database contains approved drugs, their  indications, and clinical trial outcomes.
domains:
  - drug discovery
  - pharmacology
  - clinical
...
products:
  ...
  - category: GraphicalInterface
    description: Interactive web interface for exploring RepoDB data with drug-centric  and disease-centric search capabilities
