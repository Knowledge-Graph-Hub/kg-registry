...
- category: GraphProduct
  compression: targz
  description: KGX TSV transform of Coleoptera Anatomy Ontology (COLAO), produced
    by KG-Bioportal from the BioPortal submission. The archive contains COLAO_nodes.tsv
    and COLAO_edges.tsv.
  edge_count: 2691
  format: kgx
