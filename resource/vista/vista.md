...
description: The VISTA Enhancer Browser is a database of experimentally validated
  human and mouse noncoding fragments with gene enhancer activity as assessed in transgenic
  mice. Elements are tested in vivo and annotated with their tissue-specific enhancer
  activity patterns.
domains:
- genomics
...
- category: GraphicalInterface
  description: Web interface for browsing and searching experimentally validated tissue-specific
    enhancers.
  format: http
  id: vista.site
  is_public: true
