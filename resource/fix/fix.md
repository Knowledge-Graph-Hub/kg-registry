...
products:
  ...
  - category: OntologyProduct
    ...
    warnings:
      - 'File was not able to be retrieved when checked on 2026-05-04: Error connecting to URL: No connection adapters were found for ''ftp://ftp.ebi.ac.uk/pub/databases/chebi/ontology/fix.obo'''
      - 'File was not able to be retrieved when checked on 2026-05-09: Error connecting to URL: No connection adapters were found for ''ftp://ftp.ebi.ac.uk/pub/databases/chebi/ontology/fix.obo'''
    original_source:
      - source: fix
        relation_type: prov:hadPrimarySource
publications: []
